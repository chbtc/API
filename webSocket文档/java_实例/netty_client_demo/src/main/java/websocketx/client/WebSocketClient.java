...
public class WebSocketClient {
	...
	public static String accessKey = "311f2960-xxxx-xxxx-9fb1-2c4fd17494c7";
	public static String secretKey = "940e43e1-xxxx-xxxx-b59a-6cf3cdefb4da";
	public static String serverUrl = "wss://api.chbtc.com:9999/websocket";
...
//				client.addChannel("btc_cny_ticker");
//				client.addChannel("btc_cny_depth");
//				client.addChannel("btc_cny_trades");
//				client.addChannel("btc_cny_lasttrades");
//    			client.order(9000, 0.1, "btc_cny", 0);	
//    			client.order(1000, 0.1, "btc_cny", 1);
//    			client.cancelOrder(2016062093467946L , "btc_cny");
//    			client.getOrder(2016062093467946L , "btc_cny");
//    			client.getOrders(1,1 , "btc_cny");
//    			client.getOrdersIgnoreTradeType(1,10 , "btc_cny");
//    			client.getUnfinishedOrdersIgnoreTradeType(1,10 , "btc_cny");
//				client.getOrdersNew(1,10, 1, "btc_cny");
//				client.getUserAddress("btc_cny");
//				client.getWithdrawAddress("btc_cny");
//				client.getWithdrawRecord("btc_cny", 1, 15);
//				client.withdraw("btc_cny", new BigDecimal("0.01"), new BigDecimal("0.001").setScale(8, BigDecimal.ROUND_UP), "14f+xEPirL9fyfw1i9EF439Pq6gQ5xijUmp");
//				client.cancelWithdraw("btc_cny", "2016042911327");
				
//				client.addChannel("ltc_cny_ticker");
//				client.addChannel("ltc_cny_depth");
//				client.addChannel("ltc_cny_trades");
//				client.addChannel("ltc_cny_lasttrades");
//    			client.order(100, 0.1, "ltc", 0);	
//    			client.order(1, 0.1, "ltc", 1);
//    			client.cancelOrder(20151006160133624L , "ltc");
//    			client.getOrder(20151006160133556L , "ltc");
//    			client.getOrders(1,1 , "ltc");
//    			client.getOrdersIgnoreTradeType(1,10 , "ltc");
//    			client.getUnfinishedOrdersIgnoreTradeType(1,10 , "ltc");
//				client.getOrdersNew(1,10, 1, "ltc");
//				client.getUserAddress("ltc");
//				client.getWithdrawAddress("ltc");
//				client.getWithdrawRecord("ltc", 1, 15);
//				client.withdraw("ltc", new BigDecimal("0.1"), new BigDecimal("0.01"), "LXv89ZcbT5aatWKkZXgxi4EUDBDQ72Nd8k");
//				client.cancelWithdraw("ltc", "201604253968");
				
//				client.addChannel("eth_cny_ticker");
//				client.addChannel("eth_cny_depth");
//				client.addChannel("eth_cny_trades");
//				client.addChannel("eth_cny_lasttrades");
//    			client.order( 100, 1, "eth", 0);
//    			client.order( 10, 1, "eth", 1);
//    			client.cancelOrder(20151006160133624L , "eth");
//    			client.getOrder(20151006160133556L , "eth");
//    			client.getOrders(1,1 , "eth");
//    			client.getOrdersIgnoreTradeType(1,10 , "eth");
//    			client.getUnfinishedOrdersIgnoreTradeType(1,10 , "eth");
//				client.getOrdersNew( 1,10, 1, "eth");
//				client.getUserAddress("eth");
//				client.getWithdrawAddress("eth");
//				client.getWithdrawRecord("eth", 1, 15);
//				client.withdraw("eth", new BigDecimal("0.1"), new BigDecimal("0.01"), "0x9d1062e7040857aa199480fdc0baae896bc1a9a9");
//				client.cancelWithdraw("eth", "20160425916");
				
				client.addChannel("eth_btc_ticker");
//				client.addChannel("eth_btc_depth");
//				client.addChannel("eth_btc_trades");
//				client.addChannel("eth_btc_lasttrades");
    			client.order( 0.019258, 1, "eth_btc", 0);
    			client.order( 0.009258, 1, "eth_btc", 1);
